# TN +2 Botany — Annual (12th-botany-2026)

> Source PDF: `docs/assets/annual/12th-botany-2026.pdf`
...
the  option  code  and  the  corresponding  answer.
 ...
 share your study materials with us at
9032
...
The enzyme which eliminates the torsional stress caused by the unwinding of double helix
during the DNA replication is :
...
(b) Making  artificial  genes.

(c) Making artificial limbs, diagnostic instruments such as ECG, EEG etc.,

(d) Hybridization of DNA of one organism to that of the others.
...
In which technique is Ethidium Bromide used ?
...
Tertiary consumers → Producers → Primary consumers  → Secondary consumers
...
Plant indicator for SO2  pollution is :

(a) Gladiolus,  Eucalyptus
...
Steveocide  -  Natural  Sweetener

Palmyra - Native of Brazil

Palmyra sap - Fermented to give ethanol

(d)

Saccharum  -  Abundant  in  Kanyakumari
...
Name any two nutrient media that you have studied.

Write the names of the scientists who rediscovered Mendelism.

Draw and label a cut opened Dicot seed.

What  are  agrochemicals  ?

Name the humors that are responsible for the health of human beings.

A  person  gets  irritation  while  applying  chemical  dye.    What  would  be  your  suggestion  for
alternative  ?
...
In a grassland ecosystem an organism of (T3) third trophic level derives 400 joules of energy.
How much energy would be there in first trophic (T1) level ? Calculate.
...
Differentiate  incomplete  dominance  with  co-dominance.

List out the benefits of seed treatment.

What is bioremediation ?  Give an example of bioremediation.

Give four examples of plants cultivated in commercial agroforestry.

List out the advantages of Artificial seeds.

Name any three plants found in Sub-Alpine forests.

Give short note on pollen kitt.

Draw  and  label  the  structure  of  epiphytic  plant  Vanda.
...
List out the applications of single cell protein.
...
(b) Which is called as the “King of Spices” ?  Write its origin and uses.
...
List out the traditional methods of seed protection.

OR

(b) What is negative interaction ?  Tabulate its types and effects with example.

38.

(a) Mention the name of man-made cereal.  How is it formed ?

OR

(b)

Shape of pyramid in a particular ecosystem is always different in shape. Explain with
example.
